...
foreach ($myOffers as $row) {
    ...
    echo '<button class="AcceptOffer" data-id_offer="' . htmlspecialchars($row["offer_id"]) . '" onclick="accept_offer(\'' . htmlspecialchars($row["offer_id"]) . '\', \'' . htmlspecialchars($row["offer_category"]) . '\', \'' . htmlspecialchars($row["offer_product_name"]) . '\', \'' . htmlspecialchars($row["offer_quantity"]) . '\', \'' . htmlspecialchars($row["latitude"]) . '\', \'' . htmlspecialchars($row["longitude"]) . '\')" disabled>Accept</button>';
    echo '</div>';
    echo '</div>';
}
?>
