...
function Waiting_offers_markers(data) {
  ...
  waitingOffersLayer = L.markerClusterGroup();
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var message2 = '<strong>'+first_name + ' ' + last_name + ' Οffffffffers:</strong><br>' + '<strong>From ' + offer_category + '</strong>: ' + offer_product_name + '<br><strong>For</strong>: ' 
...
function On_way_requests_markers(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var delivery_button = '<button class="Delivery" onclick="handle_offers(' + id_request + ')">Deliver</button>';
        var delete_button = '<button class="Delete" onclick="handle_offers(' + id_request + ')">Delete</button>';
...
function On_way_Offers_markers(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var delete_button = '<button class="Delete" onclick="handle_offers(' + offer_id + ')">Delete</button>';
